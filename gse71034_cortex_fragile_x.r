...
# R scripts generated  Mon Sep 24 22:15:56 EDT 2018
...
gsms <- "0000011111XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
sml <- c()
...
write.table(tT,file="C:/gse71034_cortex_fragile_x.txt" ,row.names=F, sep="\t")
# save as txt
